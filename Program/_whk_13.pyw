...
class FiseDeMagazie():
    ...
    def __init__(self, app, oi):  # app = tkinter.Tk()
        self.app = app
        self.oi = oi
        ...
        desfasurator_setari = tkinter.Menu(bara_meniu, tearoff = 0)
        desfasurator_ajutor = tkinter.Menu(bara_meniu, tearoff = 0)

        bara_meniu.add_cascade(label = self.oi['menu_file']['fil'], menu=desfasurator_fise)
        bara_meniu.add_cascade(label = self.oi['menu_calculus']['cal'], menu=desfasurator_calcule)
        bara_meniu.add_cascade(label = self.oi['menu_settings']['se'], menu=desfasurator_setari)  
        bara_meniu.add_cascade(label = self.oi['menu_help']['hl'], menu=desfasurator_ajutor)
        ...
        desfasurator_fise.add_command(label=self.oi['menu_file']['cfm'],
                                    command=self.creaza_fise_magazie)
        #desfasurator_fise.add_command(label="Inlocuieste in fise mag",
        #                           command=self.inlocuieste)
        desfasurator_fise.add_command(label=self.oi['menu_file']['cra'])
        desfasurator_fise.add_command(label=self.oi['menu_file']['crs'],
                                    command=self.creaza_raport_stocuri)
        desfasurator_fise.add_command(label=self.oi['menu_file']['cNB'],
                                    command=self.creaza_nir_bc)
        desfasurator_fise.add_command(label=self.oi['menu_file']['chl'],
                                    command=self.schimba_limba)
        ...
        ###             |- Calcule pierderi
        ###             |- Transformari
        desfasurator_calcule.add_command(label=self.oi['menu_calculus']['cap'],
                                    command=self.calcul_pierderi)
        desfasurator_calcule.add_command(label=self.oi['menu_calculus']['tra'],
                                    command=self.transform)

        ### Settings +
        ###          |- Settings
        ###          |- Help
        desfasurator_setari.add_command(label=self.oi['menu_settings']['se'],
                                    command=self.setari)
        desfasurator_setari.add_command(label=self.oi['menu_settings']['he'],
                                    command=self.ajutor)
        ...
        ###        |- Ordin 2634 din 2015
        ###        |- Trimis inapoi
        desfasurator_ajutor.add_command(label=self.oi['menu_help']['ca'],
                                    command=self.contabilitate)
        desfasurator_ajutor.add_command(label=self.oi['menu_help']['di'],
                                    command=self.dictionar)
        desfasurator_ajutor.add_command(label=self.oi['menu_help']['or'],
                                    command=self.ordin)
        desfasurator_ajutor.add_command(label=self.oi['menu_help']['tr'],
                                    command=self.sendback)
        desfasurator_ajutor.add_command(label=self.oi['menu_help']['co'],
                                    command=self.contacte)
        desfasurator_ajutor.add_command(label=self.oi['menu_help']['io'],
        ...
        self.frame_stanga = tkinter.LabelFrame(self.app, text='   ',
                                            fg='DodgerBlue2')
        self.frame_stanga.grid(row=0, column=0, stick='nsew')
        self.frame_mijloc = tkinter.LabelFrame(self.app, text='   ',
                                            fg='DodgerBlue2')
        self.frame_mijloc.grid(row=0, column=1, stick='nsew')
        self.frame_dreapta = tkinter.LabelFrame(self.app, text='   ',
                                            fg='DodgerBlue2')
        ...
        ###     Randul I si II
        ###     Data
        data_label = tkinter.Label(self.frame_mijloc, text=self.oi['program']['date'])
        data_label.grid(row=0, column=0)
        self.data_entry = tkinter.Entry(self.frame_mijloc)
        self.data_entry.grid(row=1, column=0, padx=3)
        ###     Document
        document_label = tkinter.Label(self.frame_mijloc, text=self.oi['program']['docu'])
        ...
        self.intrare_radiobutton = tkinter.Radiobutton(self.frame_mijloc,
                text=self.oi['program']['inpu'], variable = self.adauga_scade, value = 1)
        self.iesire_radiobutton = tkinter.Radiobutton(self.frame_mijloc,
                text=self.oi['program']['outp'], variable = self.adauga_scade, value = 2)
        ...
        ###      Cantitate
        cantitate_label = tkinter.Label(self.frame_mijloc, text=self.oi['program']['cant'])
        ...
        ###      Salveaza - OK
        salveaza_label = tkinter.Label(self.frame_mijloc, text=self.oi['program']['save'])
        ...
        deschide_fila_but_text = tkinter.Button(self.frame_mijloc,
                text=self.oi['program']['opfi'], command=self.deschide_fila_cu_notepad,
        ...
        deschide_fila_buton = tkinter.Button(self.frame_mijloc,
                text=self.oi['program']['opfo'], command=self.deschide_director_cu_fm,
        ...
        self.open_imagine = tkinter.Button(self.frame_mijloc,
                text=self.oi['program']['seep'], command=self.open_img, border=0, fg='DodgerBlue2')
        self.open_imagine.grid(row=2, column=0, sticky='w')
        ###      Deschide necesar
        self.deschide_necesar_but_text = tkinter.Button(self.frame_mijloc,
                text=self.oi['program']['opne'], command=self.deschide_necesar_cu_notepad,
                borderwidth=0 , fg='DodgerBlue2')
        self.deschide_necesar_but_text.grid(row=2, column=1, sticky='w')

        ###      RadioButton Intrare/Iesire
        self.iesire_radiobutton = tkinter.Radiobutton(self.frame_mijloc,
                text=self.oi['program']['inou'], variable = self.adauga_scade, value = 3)
        ...
        ###      Deschide fisa
        deschide_fila_but_com = tkinter.Button(self.frame_mijloc, text=self.oi['program']['orde'],
        ...
        deschide_fila_but_text = tkinter.Button(self.frame_dreapta,
                text=self.oi['program']['opfi'], command=self.deschide_todo, borderwidth=0 , fg='DodgerBlue2')
        deschide_fila_but_text.grid(row=2, column=0, padx = 3, sticky='w')
        save_fila_but_text = tkinter.Button(self.frame_dreapta,
                text=self.oi['program']['save'], command=self.save_todo, borderwidth=0 , fg='DodgerBlue2')
...
########################################################################################
        ...
        try:
            ...
            # ADUNARE/SCADERE
                ...
                try:
                    ...
                    tkinter.messagebox.showinfo(self.oi['program']['info'], self.oi['program']['inf1'])
                stoc_nou = self.cantitate + stoc_vechi
                stoc_zero = 0
                ...
                tkinter.messagebox.showinfo(self.oi['program']['info'], self.oi['program']['inf2'])


        except ValueError as e:
            tkinter.messagebox.showinfo(self.oi['program']['info'], self.oi['program']['inf3'])
    ...
    def afiseaza_data_timpul(self):
        ...
        d = {'Sunday':self.oi['days']['sun'], 'Monday':self.oi['days']['mon'], 'Tuesday':self.oi['days']['thu'],
            'Wednesday':self.oi['days']['wed'], 'Thursday':self.oi['days']['thr'], 'Friday':self.oi['days']['fri'],
            'Saturday':self.oi['days']['sat'],}
    ...
    def actualizari(self):
        '''Actualizari - Info.'''
        tkinter.messagebox.showinfo(self.oi['program']['inf4'], self.oi['program']['inf4'])
...
#######################################################################
    ...
    def creaza_fise_magazie(self):
        ...
        creaza_fise_magazie_12.gui(self.lista_f, self.oi['cfmag'])

    def creaza_nir_bc(self):
        '''creaza nir si bon consum'''
        nir_bc.gui()
        
    def schimba_limba(self):
        '''Schimba limba: engleza-romana.'''
        cnf = configparser.ConfigParser()
        with open('../Program/start.ini', 'r') as f:
            cnf.read_file(f)
            lng = cnf['Language']['lang']
            match lng:
                case "eng":
                    cnf['Language']['lang'] = 'rom'
                    with open('../Program/start.ini', 'w') as f:
                        cnf.write(f)
                case "rom":
                    cnf['Language']['lang'] = 'eng'
                    with open('../Program/start.ini', 'w') as f:
                        cnf.write(f)
                case _:
                    ...
        tkinter.messagebox.showinfo(self.oi['program']['info'], self.oi['program']['inf5'])
    ...
    def open_img(self):
        ...
        def mareste():
            ...
            l.grid(row=1)
            b = tkinter.Button(a, text=self.oi['program']['pzo'], command=micsoreaza)
        ...
        def micsoreaza():
            ...
            l = tkinter.Label(a, image=img)
            l.grid(row=1)
            b = tkinter.Button(a, text=self.oi['program']['pzi'], command=mareste)
            b.grid(row=0, sticky='we')
            a.mainloop()
        ...
        try:
            ...
            mat = radacina + "no_image_available" + '.png'
            foto = Image.open(mat)
        h = foto.height
        w = foto.width
        foto_resized = foto.resize((int(w/2), int(h/2)))
...
if __name__ == '__main__':
    ...
    with open("start.ini", "r") as f:
        obj.read_file(f) 
        l = obj.get("Language", "lang")
    object_ini = get_lang(l)
    root = tkinter.Tk()
    app = FiseDeMagazie(root, object_ini)
    root.mainloop()
